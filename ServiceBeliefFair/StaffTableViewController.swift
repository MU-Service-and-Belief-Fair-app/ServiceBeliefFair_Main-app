...
class StaffTableViewController: UITableViewController {
    ...
    let staffNames = [ SteveDiSalvo, ErinSchreiber, FrNoahWaldman]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = staffNames[indexPath.row].name
        cell.detailTextLabel?.text = staffNames[indexPath.row].title
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let vc =  segue.destination as? StaffInDetailViewController,
            let indexPath = tableView.indexPathForSelectedRow {
            vc.staffInfo = staffNames[indexPath.row]
        }
